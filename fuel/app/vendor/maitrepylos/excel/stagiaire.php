...
class Stagiaire {
    ...
    public static function excel($sheet,$cedefop,$data,$heure,$xml=null,$filiere=null,$annee=null) {
...
//        $sheet->setCellValue('AE11', '(14.5)');
        ...
        $sheet->setCellValue('E7', $cedefop);
        $count = count($data);
        for ($i=0;$i<$count;$i++) {

            $cellule = (12+$i);
            $sheet->setCellValueByColumnAndRow(0,$cellule,($i+1));
            $sheet->setCellValueByColumnAndRow(1,$cellule,$data[$i]['t_nom']);
            $sheet->setCellValueByColumnAndRow(2,$cellule,$data[$i]['t_prenom' ]);
            $sheet->setCellValueByColumnAndRow(3,$cellule,$data[$i]['t_nom_rue']);
            $sheet->setCellValueByColumnAndRow(4,$cellule,$data[$i]['t_code_postal']);
            $sheet->setCellValueByColumnAndRow(5,$cellule,$data[$i]['d_date_naissance']);
            $sheet->setCellValueByColumnAndRow(6,$cellule,$data[$i]['t_sexe']);
            $sheet->setCellValueByColumnAndRow(7,$cellule,(int)$data[$i]['t_nationalite']);
            $sheet->setCellValueByColumnAndRow(8,$cellule,$data[$i]['t_situation_sociale']);
            $sheet->setCellValueByColumnAndRow(9,$cellule,$data[$i]['d_date_inscription_forem']);
            $sheet->setCellValueByColumnAndRow(10,$cellule,$data[$i]['tDureeInoccupation']);
            $sheet->setCellValueByColumnAndRow(11,$cellule,$data[$i]['t_diplome']);
            $sheet->setCellValueByColumnAndRow(12,$cellule,$data[$i]['t_type_etude']);
            $sheet->setCellValueByColumnAndRow(13,$cellule,$data[$i]['d_date_debut_contrat']);
            $sheet->setCellValueByColumnAndRow(14,$cellule,$data[$i]['d_date_fin_contrat']);
            $sheet->setCellValueByColumnAndRow(15,$cellule,$heure[$data[$i]['id_participant']]['eft']/(24*3600));
            $sheet->setCellValueByColumnAndRow(16,$cellule,$heure[$data[$i]['id_participant']]['gratuit']/(24*3600));
            $sheet->setCellValueByColumnAndRow(17,$cellule,$heure[$data[$i]['id_participant']]['payant']/(24*3600));
            $sheet->setCellValueByColumnAndRow(18,$cellule,$heure[$data[$i]['id_participant']]['stage']/(24*3600));
            $sheet->setCellValueByColumnAndRow(19,$cellule,'10%');
            $sheet->setCellValueByColumnAndRow(20,$cellule,$heure[$data[$i]['id_participant']]['assimile']/(24*3600));
            //$sheet->setCellValueByColumnAndRow(20,$cellule,'10%');
//            $sheet->setCellValueByColumnAndRow(16,$cellule,$data[$i]->trimestre1[0]->trimestre/(24*3600));
//            $sheet->setCellValueByColumnAndRow(17,$cellule,$data[$i]->trimestre2[0]->trimestre/(24*3600));
//            $sheet->setCellValueByColumnAndRow(18,$cellule,$data[$i]->trimestre3[0]->trimestre/(24*3600));
//            $sheet->setCellValueByColumnAndRow(19,$cellule,$data[$i]->trimestre4[0]->trimestre/(24*3600));
            $sheet->setCellValueByColumnAndRow(21,$cellule,$data[$i]['t_fin_formation_suite']);
//        $sheet->setCellValueByColumnAndRow(22,$cellule,$data[$i]->annee_precedente[0]->trimestre/(24*3600));
            $sheet->setCellValueByColumnAndRow(22,$cellule,$heure[$data[$i]['id_participant']]['precedente']/(24*3600));
        ...
        $sheet->setCellValueByColumnAndRow(19,$Newcellule,'10%');
