...
class Signaletique
{
    ...
    public static function pdf($formData)
    {
        ...
        $pdf->SetFont('Times', 'I', 10);
        $pdf->Write(5, utf8_decode('vous rembourse vos '));
        $pdf->SetFont('Times', 'IB', 10);
        $pdf->Write(5, utf8_decode('frais de déplacement, '));
        $pdf->SetFont('Times', 'I', 10);
        $pdf->Write(5, utf8_decode('si vous habitez à plus de 1 Km du centre '));
        $pdf->SetXY(23, 146);
        $pdf->Cell('', '', utf8_decode('de formation et vous aloue '));
        $pdf->SetXY(63, 146);
        $pdf->SetFont('Times', 'IB', 10);
        ...
        $pdf->SetXY(23, 222);
        $pdf->Cell('', '', utf8_decode('Indiquer le nom de votre Mutuelle : ') . $formData['t_mutuelle']);
        $pdf->SetXY(132, 222);
